    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-2xl max-w-2xl w-full p-8 transform transition-all animate-fade-in-up">
        ...
        <p className="text-gray-600 mb-6">
          Professional localization analysis tool. Get instant technical metrics, expansion analysis, and AI-powered quality insights for translation quality assurance.
        </p>
        ...
        <ol className="list-decimal list-inside space-y-2 text-gray-700 mb-8">
          ...
          <li><strong>Visual Diff:</strong> Character-level comparison with linguistic context.</li>
          <li><strong>AI Analysis:</strong> Generate expert prompts for LLM quality evaluation.</li>
          <li><strong>Professional Workflow:</strong> Designed for localization managers handling unfamiliar languages.</li>
        </ol>
